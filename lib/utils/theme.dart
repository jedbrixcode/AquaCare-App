...
final darkTheme = ThemeData.dark(useMaterial3: false).copyWith(
  ...
  textTheme: const TextTheme(
    displayLarge: TextStyle(color: Color.fromARGB(255, 200, 200, 200)),
    displayMedium: TextStyle(color: Color.fromARGB(255, 200, 200, 200)),
    displaySmall: TextStyle(color: Color.fromARGB(255, 200, 200, 200)),
    headlineLarge: TextStyle(color: Color.fromARGB(255, 200, 200, 200)),
    headlineMedium: TextStyle(color: Color.fromARGB(255, 200, 200, 200)),
    headlineSmall: TextStyle(color: Color.fromARGB(255, 200, 200, 200)),
    titleLarge: TextStyle(color: Color.fromARGB(255, 200, 200, 200)),
    titleMedium: TextStyle(color: Color.fromARGB(255, 200, 200, 200)),
    titleSmall: TextStyle(color: Color.fromARGB(255, 200, 200, 200)),
    bodyLarge: TextStyle(color: Color.fromARGB(255, 200, 200, 200)),
    bodyMedium: TextStyle(color: Color.fromARGB(255, 200, 200, 200)),
    bodySmall: TextStyle(color: Color.fromARGB(255, 200, 200, 200)),
    labelLarge: TextStyle(color: Color.fromARGB(255, 200, 200, 200)),
    labelMedium: TextStyle(color: Color.fromARGB(255, 200, 200, 200)),
    labelSmall: TextStyle(color: Color.fromARGB(255, 200, 200, 200)),
  ),
