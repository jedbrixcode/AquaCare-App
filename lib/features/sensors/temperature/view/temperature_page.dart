                  ...
                  child: IntrinsicHeight(
                    child: Column(
                      ...
                      children: [
                            ...
                            children: [
                              ...
                              notifAsync.when(
                                ...
                                loading:
                                    () => SizedBox(
                                      height:
                                          ResponsiveHelper.getCardHeight(
                                            context,
                                          ) /
                                          10,
                                      width:
                        ...
                        SizedBox(
                          height:
                              ResponsiveHelper.verticalPadding(context) + 14,
                        ),
                        ...
                        SizedBox(
                          height:
                              ResponsiveHelper.verticalPadding(context) / 12,
                        ),
                        Divider(color: Colors.grey[300], thickness: 1),
                        SizedBox(
                        ...
                        SizedBox(
                          height:
                              ResponsiveHelper.verticalPadding(context) + 18,
                        ),
                      ],
                    ),
                  ),
